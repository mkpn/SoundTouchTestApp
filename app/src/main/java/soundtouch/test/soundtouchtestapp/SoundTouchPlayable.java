...
import static soundtouch.test.soundtouchtestapp.Constants.BUFFER_SIZE_TRACK;
...
public class SoundTouchPlayable implements Runnable
{
	...
	public void run()
	{
		...
		catch (soundtouch.test.soundtouchtestapp.DecoderException e)
		{
			e.printStackTrace();
		}
		finally
	...
	private void playFile() throws soundtouch.test.soundtouchtestapp.DecoderException
	{
		byte[] input = null;
		int bytesReceived = 0;
	...
	private byte[] processChunk() throws soundtouch.test.soundtouchtestapp.DecoderException
	{
	...
	private int processChunkForInt() throws soundtouch.test.soundtouchtestapp.DecoderException
	{
		byte[] input;
		int bytesReceived = 0;
